...
public class FsmFactoryImpl extends EFactoryImpl implements FsmFactory {
	...
	public EObject create(EClass eClass) {
		...
		case FsmPackage.STATE_ON:
			return createStateOn();
		case FsmPackage.STATE_OFF:
			return createStateOff();
		case FsmPackage.STATE_FINAL:
			return createStateFinal();
		default:
	 ...
	 * @generated
	 */
	public StateFinal createStateFinal() {
		StateFinalImpl stateFinal = new StateFinalImpl();
		return stateFinal;
	}
	 ...
	 * @generated
	 */
	public StateOn createStateOn() {
		StateOnImpl stateOn = new StateOnImpl();
		return stateOn;
	}
	 ...
	 * @generated
	 */
	public StateOff createStateOff() {
		StateOffImpl stateOff = new StateOffImpl();
		return stateOff;
	}
