...
public class FSMItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(FsmPackage.Literals.FSM__STATE, FsmFactory.eINSTANCE.createStateOn()));

		newChildDescriptors
				.add(createChildParameter(FsmPackage.Literals.FSM__STATE, FsmFactory.eINSTANCE.createStateOff()));

		newChildDescriptors
				.add(createChildParameter(FsmPackage.Literals.FSM__STATE, FsmFactory.eINSTANCE.createStateFinal()));
